...
// ===== Tareas =====
// Obligatorias: definen el % de victoria. Opcionales: suman puntos pero no restan.
...
function tareasDelDia(){
  return [
    ...
    { key:"milo_humedo", group:"Milo", title:"Alimento húmedo + suplementos", detail:"Un poco de Royal Canin + 2 pastillas trituradas", opcional:true },
    ...
    { key:"zoe_humedo", group:"Zoe", title:"Alimento húmedo + suplementos", detail:"Sieger + 2 pastillas trituradas + 10 gotas Proteliv + 1ml Felifat", opcional:true },
    { key:"piedras", group:"General", title:"Limpiar piedras", detail:"Al menos día por medio, en cocina o baño", opcional:true },
  ];
}
